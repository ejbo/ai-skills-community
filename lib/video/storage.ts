 ...
 * ffmpeg is missing, the file is too large, the media queue is too busy to reach
 * in time, or anything fails. NEVER throws, so a missing ffmpeg on the box can't
 * break uploads.
 */
