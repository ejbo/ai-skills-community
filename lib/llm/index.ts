...
export function isLLMConfigured(): boolean {
  ...
  return Boolean(cfg.apiKey && cfg.model && cfg.baseUrl);
}
...
export function getProvider(): LLMProvider {
  ...
  cached =
    cfg.provider === 'openai-compatible'
      ? new OpenAiProvider({ apiKey: cfg.apiKey, baseUrl: cfg.baseUrl, model: cfg.model })
      : new AnthropicProvider({ apiKey: cfg.apiKey, baseUrl: cfg.baseUrl, model: cfg.model });
  return cached;
}
